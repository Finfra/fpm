...
canonical_header = (
    ...
    "    <a class=\"hub-link\" href=\"http://__HOST__:__PORT__/hub\" target=\"_blank\" title=\"통합 모니터링 Hub\"><img src=\"/fpm-icon.png\" alt=\"Hub\" style=\"height:1.2em;vertical-align:-0.25em;\"></a>\n"
