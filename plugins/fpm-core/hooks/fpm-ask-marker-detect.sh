...
# SID / project meta 산정 — ask-common.sh (intercept 와 공용, Issue424_2)
ask_ctx_sid "$session_id" "$cwd"

ask_ctx_project_meta "$cwd"

# OUT_DIR (Issue289/Issue258) — ask-common.sh
ask_ctx_out_dir "$cwd"

# Server healthz + register — ask-common.sh
ask_ctx_server "$cwd"
