...
#   ex) cdf-rel $HOME/Documents/finfra/<private-project-2>/_doc_arch/file.md
#       → _doc_arch/file.md
#       cdfr (alias)
cdf-rel() {
...
#   ex) cdf-base $HOME/Documents/finfra/<private-project-2>/_doc_arch/x.md
#       → $HOME/Documents/finfra/<private-project-2>
